...
public class PruebaContenedor {
    ...
    public static void pruebasContenedor() {
        ContenedorDeEnteros prueba = new ContenedorDeEnteros();
        /*int[] ele = {6, 3, 1, 7, 0, 14, 65, 88, 90};
        for(int i = 0; i < ele.length; i++) {
            prueba.insertar(ele[i]);
        }
        prueba.extraer(0);*/
        ...
        if (prueba.buscar(-1)) System.out.println("Error se encuentra un elemento inexistente (-1)");
       	if (!prueba.insertar(15)) System.out.println("Error no se he inserta el elemento (15)");
        if (prueba.insertar(5)) System.out.println("Error se inserta un elemento repetido (5)");
        if (!prueba.extraer(15)) System.out.println("Error no se ha extraido el elemento (15)");
        if (prueba.buscar(15)) System.out.println("Error se ha encontrado el elemento (15)");
        if (!prueba.extraer(5)) System.out.println("Error no se ha extraido el elemento (5)");
        if (prueba.buscar(5)) System.out.println("Error se ha encontrado el elemento (5)");
        if (!prueba.extraer(2)) System.out.println("Error no se ha extraido el elemento (2)");
        if (prueba.buscar(2)) System.out.println("Error se ha encontrado el elemento (2)");
    ...
    public static void pruebasRendimiento(){
        ...
        try {
            ...
            salida = new PrintStream(new File("salida3.txt"));
            ...
            for (int i = 0; i < 10; i++){
                ...
                salida.println((t2 - t1)/10000000. + " ms");
                System.out.println((t2 - t1)/10000000. + " ms");
            }
            ...
            for(int i = 0; i < 10; i++){
                ...
                long t2 = System.nanoTime();
                salida.println((t2-t1)/(10000000.*(i+1)) + " ms");
                System.out.println((t2-t1)/(10000000.*(i+1)) + " ms");
            }
            contenedor.vaciar();
            ...
            for(int i = 0; i < 10; i++){
                ...
                long t2 = System.nanoTime();
                salida.println((t2-t1)/20000000. + " ms");
                System.out.println((t2-t1)/20000000. + " ms");
            }
